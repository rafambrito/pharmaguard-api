...
- adapters.out persiste/consulta e integra com mecanismos de seguranca.
...
| T1.4.1 | Implementar adapters JPA Usuario/Perfil | repositorios JPA na camada adapters.out | ✅ Concluído |
...
| T1.13.1 | Definir regras de dependencia entre camadas | regras impedindo violacao de Clean Architecture (adapters.in -> application -> domain) | ✅ Concluído |
...
| T1.13.3 | Definir regras para adapters e frameworks | dominio sem dependencia de frameworks e adapters restritos a adapters.out | ✅ Concluído  |
