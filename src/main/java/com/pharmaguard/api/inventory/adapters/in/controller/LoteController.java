...
import com.pharmaguard.api.inventory.adapters.in.controller.doc.LoteControllerDoc;
...
public class LoteController implements LoteControllerDoc {
    ...
    public LoteController(LoteUseCase loteUseCase, InventoryAdapterInMapper mapper) {
