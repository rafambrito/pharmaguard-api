...
public record CriarUsuarioRequest(
        ...
        @NotBlank(message = MessageKeys.MSG_VALIDACAO_TIPO_OBRIGATORIO) @Size(max = 50, message = MessageKeys.MSG_VALIDACAO_TIPO_TAMANHO_MAXIMO) String tipo,
        @NotBlank(message = MessageKeys.MSG_VALIDACAO_SENHA_OBRIGATORIA) @Size(min = 6, message = MessageKeys.MSG_VALIDACAO_SENHA_TAMANHO_MINIMO) String senha,
